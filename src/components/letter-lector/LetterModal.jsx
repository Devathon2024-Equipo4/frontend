...
const LetterModal = ({ content, onClose }) => {
  ...
  return (
    <div className="fixed font-DynaPuff inset-0 bg-plantation bg-opacity-50 flex justify-center items-center">
      <div className="bg-loblolly p-4 rounded-lg shadow-lg w-10/12 sm:w-1/2">
        <h2 className="text-xl text-plantation font-semibold mb-2">Detalle</h2>
        <p>{content}</p>
        <button
